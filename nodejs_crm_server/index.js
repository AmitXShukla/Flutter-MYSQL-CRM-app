...
app.post('/getuser', urlencodedParser, function (req, res) {
    ...
    //if(valFunctions.checkUserAuthRole(req,res)) return false;
    var dbFunctions = require('./models/connector');
    var jwtData = valFunctions.checkJWTToken(req,res);
    if(jwtData.error) {
        res.statusCode = 200;
        return res.send(jwtData);
    }
    dbFunctions.getUser(jwtData,req,res);
});
app.post('/setuser', urlencodedParser, function (req, res) {
    var dbFunctions = require('./models/connector');
    var jwtData = valFunctions.checkJWTToken(req,res);
    if(jwtData.error) {
        res.statusCode = 200;
    ...
    dbFunctions.setUser(jwtData,req,res);
});
app.post('/setdata', urlencodedParser, function (req, res) {
    var dbFunctions = require('./models/connector');
    var jwtData = valFunctions.checkJWTToken(req,res);
    if(jwtData.error) {
        res.statusCode = 200;
...
app.post('/setlocation', urlencodedParser, function (req, res) {
    if(valFunctions.checkInputDataNULL(req,res)) return false;
   // if(valFunctions.checkInputDataQuality(req,res)) return false;
    //if(valFunctions.checkUserAuthRole(req,res)) return false;
    var dbFunctions = require('./models/connector');
...
//app.get('/getlocation', urlencodedParser, function (req, res) {
//    //if(valFunctions.checkInputDataNULL(req,res)) return false;
//    //if(valFunctions.checkInputDataQuality(req,res)) return false;
//    //if(valFunctions.checkUserAuthRole(req,res)) return false;
//    var dbFunctions = require('./models/connector');
